...
# Debug Console Viewport 3D - 3D worldspace panel for debug output

@export var pointer_group: StringName = &"pointer_interactable"
@export var ui_size: Vector2 = Vector2(600, 400)
@export var quad_size: Vector2 = Vector2(2.4, 1.6)  # Aspect ratio matches 600:400
...
func handle_pointer_event(event: Dictionary) -> void:
	...
	if debug_coordinates:
		print("DebugConsoleViewport: Hit uv=", uv)
