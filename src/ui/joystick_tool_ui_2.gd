...
# Joystick Tool UI 2 - Undo/Redo Variant
# Duplicate of joystick_tool_ui.gd with updated icons
...
func _update_visuals(input: Vector2) -> void:
	...
	if trigger_held:
		...
		icon_up.text = "✋"
		icon_down.text = "🧲" # Magnet
		icon_left.text = "↩"  # Undo
		icon_right.text = "↪" # Redo
...
func _process_selection(input: Vector2) -> void:
	...
	if new_selection != "" and new_selection != current_selection:
		...
		print("JoystickTool2: Selected ", current_selection)
