...
@export var ui_size: Vector2 = Vector2(640, 800)
@export var quad_size: Vector2 = Vector2(1.6, 2.0)
...
@onready var git_ui: GitPanelUI = get_node_or_null("SubViewport/GitPanelUI") as GitPanelUI
...
func refresh() -> void:
	if git_ui:
		git_ui.refresh_status()
		git_ui.refresh_history()
