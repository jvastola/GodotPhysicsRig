...
@export var ui_size: Vector2 = Vector2(640, 720)
@export var quad_size: Vector2 = Vector2(1.6, 1.8)
...
@onready var legal_ui: PanelContainer = get_node_or_null("SubViewport/LegalPanelUI") as PanelContainer
...
func refresh() -> void:
	if legal_ui and legal_ui.has_method("load_documents"):
		legal_ui.call("load_documents")
